terraform {
  backend "s3" {
      ...
      key                   = "ec2/general-instance/data-vol/terraform.tfstate"
      region                = "us-east-1"
      encrypt               = true
...
module "general_instance_data_vol" {
    source = "git::https://github.com/thatsnotamuffin/terraform.git//ec2/general_instance/data_vol?ref=<relevant tag>"
