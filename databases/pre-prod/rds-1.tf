module "rds_1" {
  ...
  snapshot_identifier  = "thatsnotamuffin-pre-prod-db-1-snapshot"
  db_identifier        = "thatsnotamuffin-pre-prod-db-1"
  ...
  final_snapshot_identifier = "thatsnotamuffin-pre-prod-db-1-final"
