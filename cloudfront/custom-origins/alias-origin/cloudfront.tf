...
resource "aws_cloudfront_distribution" "alias_custom_origin" {
    origin {
    ...
    aliases                                 = var.custom_origin_lists.aliases
    ...
    default_cache_behavior {
      ...
      min_ttl                               = var.custom_origin_settings.min_ttl
      default_ttl                           = var.custom_origin_settings.default_ttl
      max_ttl                               = var.custom_origin_settings.max_ttl
    ...
    logging_config {
      include_cookies                       = var.custom_origin_settings.include_cookies
      bucket                                = data.aws_s3_bucket.selected.bucket_regional_domain_name
      prefix                                = var.custom_origin_settings.logging_prefix
    }
